use crate::{utils::gen_unit, Beat, Second};
...
impl Sample {
    ...
    pub const SR_22050: Sample = Sample::new_raw(22050, 1);
    pub const SR_44100: Sample = Sample::new_raw(44100, 1);
    pub const SR_48000: Sample = Sample::new_raw(48000, 1);
    pub const SR_88200: Sample = Sample::new_raw(88200, 1);
    pub const SR_96000: Sample = Sample::new_raw(96000, 1);
    pub const SR_176400: Sample = Sample::new_raw(176400, 1);
    pub const SR_192000: Sample = Sample::new_raw(192000, 1);
    pub const SR_352800: Sample = Sample::new_raw(352800, 1);
    pub const SR_384000: Sample = Sample::new_raw(384000, 1);
